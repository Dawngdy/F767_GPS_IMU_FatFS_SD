...
// IMU Noise feature
#define ACC_CONST_BIAS				(250	*1.0e-6*GRAVITY_CONST)	//acc constant bias stability: ug
#define GYRO_CONST_BIAS				(6		*DEG2RAD/3600.0)		//gyro constant bias stability: deg/h
#define VEL_RAND_WALK				  (125	*1.0e-6*GRAVITY_CONST)	//velocity random walk: ug/sqrt(Hz)
#define ANG_RAND_WALK				  (0.5	*DEG2RAD/60.0)			//angular random walk: deg/sqrt(h)
